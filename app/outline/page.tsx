      ...
      <div className="mx-auto max-w-5xl px-8 py-12">
        <header className="mb-10 flex flex-wrap items-end justify-between gap-6">
          ...
          <div className="flex items-center gap-6 rounded-2xl border border-slate-200 bg-white/70 px-6 py-4 text-sm shadow-sm backdrop-blur">
            ...
            <Link
              href="/"
              className="rounded-full border border-slate-200 px-4 py-2 text-xs font-medium uppercase tracking-wider text-slate-700 transition hover:border-brand-500 hover:text-brand-700"
            >
              ← Deck
            </Link>
          </div>
        ...
        <p className="mb-12 max-w-2xl rounded-xl border border-brand-200 bg-brand-50/60 px-5 py-3 text-sm text-brand-900">
                      ...
                      >
                        <div className="col-span-3 flex flex-col gap-3">
                          <div className="flex items-baseline gap-3">
                            ...
                            <Link
                              href={`/?slide=${index + 1}`}
                              className="text-base font-semibold leading-tight text-slate-900 transition hover:text-brand-700"
                            >
                              {entry.meta.title}
                            </Link>
                          </div>
                          <div className="flex flex-wrap items-center gap-2 text-xs">
                            ...
                            {isStub ? (
                              ...
                              <span className="rounded-full bg-brand-50 px-2 py-0.5 font-mono uppercase tracking-wider text-brand-700">
                          ...
                          <Link
                            href={`/?slide=${index + 1}`}
                            className="mt-auto inline-flex w-fit items-center gap-1 text-xs text-slate-500 transition hover:text-brand-700"
                          >
                            Open slide →
                          </Link>
                        </div>
