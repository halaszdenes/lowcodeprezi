...
export const slide30b: SlideEntry = {
  meta: {
    ...
    steps: TOTAL_STEPS,
    notes:
      "I just told you internal visibility beats followers. Still true. But once you have wins, the outside matters too. Internal visibility gets you into the room; online presence gets you into the next one. [one click each]\n\n• LinkedIn especially: that's where the people hiring for these roles already scroll. A profile that shows what you built is a CV that works while you sleep.\n• Posting what you learned, what broke and what you fixed builds trust. It shows you care about the craft, not just the title.\n• Long-form, a blog or a YouTube walkthrough of something you built, is how you show depth. It's exactly how I ended up on this stage.\n• Optional advice, not homework. Keep it light.",
  },
