...
export const slide14e: SlideEntry = {
  meta: {
    ...
    notes:
      "Slow down here. On the left, Power Automate is a pipeline: you laid the rails, the train only goes where the rails go. Predictable, auditable, cheap at volume. Boring in the best sense of the word.\n\nOn the right, a Copilot Studio agent runs a reasoning loop: plan, act, observe, replan, until it can answer. Flexible, but every run can differ, and you pay for that in control and cost.\n\n• Neither is better. They fit different problems.\n• If asked: Copilot Studio also supports classic topic-based authoring, and Microsoft recommends mixing deterministic steps, human approval points and AI-driven parts inside one agent. You decide how much you hand to the AI.\n• The turn: 'So AI runs inside your solutions now. But there's something more radical coming. AI doesn't just run inside what you build. It can build it.'",
  },
