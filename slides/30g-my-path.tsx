...
export const slide30g: SlideEntry = {
  meta: {
    ...
    steps: TOTAL_STEPS,
    notes:
      "I get asked about freelancing a lot. The honest version: I never jumped. [click] I was in a finance role building the reports and apps my own team needed. A citizen developer, exactly the road from a few slides ago. [click] Then I started teaching in the evenings: trainings, then courses, then the trainer certification. Two things grew at the same time, a second income and visibility. Every training room is a room full of potential clients. [click] By the time I went full-time it wasn't a leap. Consulting, training, content. Long-term contracts, not gig hunting.\n\nThe bridge was teaching. It paid, it built proof, and it never required quitting.\n\n• Add your real years and split if you want to say them; the slide deliberately shows none.",
  },
