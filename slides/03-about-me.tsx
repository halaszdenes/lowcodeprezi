...
export const slide03: SlideEntry = {
  meta: {
    ...
    section: "Act 1 · Setup",
    notes:
      "I'm Denes, Power Platform consultant, trainer and speaker from Hungary. I started in finance and accounting, became a citizen developer when Power Platform launched in 2018, and never went back.\n\nToday I'm a Microsoft Certified Trainer with six Microsoft certifications, I lead the Hungary Power Platform User Group, I'm a regional leader in Microsoft's Global Community Initiative, and I co-founded Shift+Enter, Hungary's biggest Microsoft community conference. Ten-plus years in enterprise, with companies like LEGO, Diageo, Audi, DSV and Nokia.\n\n• The finance-to-low-code path is the exact path this talk recommends. Say that once.\n• Forty seconds maximum; the handles stay on screen for anyone who wants them.",
  },
