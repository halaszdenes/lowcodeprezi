...
export const slide29b: SlideEntry = {
  meta: {
    ...
    steps: TOTAL_STEPS,
    notes:
      "Roadmap for people who already have an office job: no career switch needed, the on-ramp is the job they have. A road draws itself on load, with a 'You, today' marker at the start and a greyed-out finish flag at the end. Each click drops a numbered pin, slides in its card, and extends the blue route line along the road to that pin.\n\n• Step 1 (load): Title + the road draws. Say: 'If you already sit in an office job, you don't have to quit anything. You're standing on the on-ramp right now.'\n• Step 2: Pin 01, Identify use cases in your job. Say: 'Look at your own week. The finance dashboard you rebuild by hand every month. The HR workflow that runs on email and an Excel file. Those are your use cases. Nobody knows them better than you.'\n• Step 3: Pin 02, Showcase small wins. Say: 'Pick one. Automate one manual Excel report. Build one simple request or tracking app. Small enough to finish in a week, visible enough that someone notices.'\n• Step 4: Pin 03, Gain visibility. The finish flag lights up: 'Your new role'. Say: 'Then show it. Your team, your manager, the meeting where that pain usually gets complained about. Visibility is what turns a side project into a new role.'\n\nBridge to the next slide (show your work internally): 'Which brings me to the part most people skip.'",
  },
