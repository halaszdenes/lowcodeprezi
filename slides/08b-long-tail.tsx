...
export const slide08b: SlideEntry = {
  meta: {
    ...
    steps: 2,
    notes:
      "The economics of low-code in one chart (Imgrund et al., 2017). Y axis: the surplus a company gets from managing a process properly. X axis: all its processes, ranked. A few processes are worth a real project; then the curve drops into a long tail. Two steps.\n\n• Step 1 (load): The curve draws, the green head zone lights up with ERP, MRP, CRM chips, then the line of manageability and the amber tail with Excel, manual workflows and paper. Say: 'Every company has a handful of processes worth an ERP, an MRP, a CRM. Big budget, big project, worth it. Then there's the line of manageability. Right of it, a process isn't worth a developer. So it runs on Excel, on email, on paper. That's the long tail, and it's most of the processes in your company.'\n• Step 2 (click): A second line appears, the blue citizen-development band slides in between with Power Platform in the middle; the tail shrinks and paper disappears. Say: 'Low-code moves the line. When a process can be automated in days by the person who owns it, a whole band of the tail suddenly becomes worth doing. That band is citizen development. That's the job.'\n\nThis is the proof behind 'the real driver is money' on the previous slide. Then: low-code is a bridge.",
  },
