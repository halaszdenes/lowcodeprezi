...
export const slide30f: SlideEntry = {
  meta: {
    ...
    steps: 4,
    notes:
      "The lesson after the story. Two circles, employment (blue) and freelancing (green); the overlap is the point. 4 steps.\n\n• Step 1 (load): Title + the two circles with headings, no items. Say: 'People frame this as a choice. Employment or freelancing. It isn't.'\n• Step 2: Employment side fills in: steady income and benefits, a structured career path, no client hunting, paid vacation and sick leave. Say: 'Employment gives you all of this. None of it is trivial.'\n• Step 3: Freelancing side: higher earning ceiling, flexible schedule, you pick the projects, your own brand grows. Say: 'Freelancing gives you this. Also not trivial.'\n• Step 4: The lens lights up: SWEET SPOT, long-term, part-time contractor. The LEGO card drops in bottom right. Say: 'The middle exists, and it's the best deal in this industry: a long-term, part-time contract with one or two clients. Steady base, freedom on top. At LEGO, back to office doesn't apply to me. The employee discount does.' Let the laugh land.\n\nThen: 'And here's how I got there.' Next slide is my own path. Keep this slide under three minutes; it's a coda, not a new act.",
  },
  Component: VennSlide,
};
