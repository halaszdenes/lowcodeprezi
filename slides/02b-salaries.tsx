...
export const slide02b: SlideEntry = {
  meta: {
    ...
    steps: 3,
    notes:
      "I promised numbers. US base pay, 2026, three big salary sites. [click] A software developer typically earns between 97 and 158 thousand dollars. [click] A Power Platform developer: 98 to 136 thousand. Same ballpark. And you get there without four years of computer science and a decade of grinding.\n\nIf asked about entry level, be straight:\n• Junior software developers report roughly 90 to 100 thousand; junior Power Platform developers roughly 70 to 87 thousand.\n• The low-code advantage at entry is speed, not pay. You get in within months, and the gap closes mid-career.\n• Glassdoor lists Power Platform developers at 175 thousand on 104 samples; left off the slide on purpose.\n• Sources: Glassdoor (software developer 123,244; 96,952 to 158,343), Salary.com (Power Platform 108,151; 98,167 to 116,903), ZipRecruiter (Microsoft Power Platform 123,611; 113 to 136 thousand).",
  },
