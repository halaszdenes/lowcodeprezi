  ...
  return (
    ...
    >
      <header className="flex items-center justify-between px-8 py-6">
        ...
        <button
          onClick={onClose}
          className="rounded-full border border-slate-200 px-4 py-2 text-sm text-slate-700 transition hover:border-brand-500 hover:text-brand-600"
        >
          Close (Esc)
        </button>
      </header>
              ...
              <li key={slide.meta.id}>
                <button
                  ...
                  className={`group relative aspect-video w-full overflow-hidden rounded-xl border text-left transition ${
                    active
                      ? "border-brand-500 shadow-[0_0_0_2px_rgba(9,132,227,0.25)]"
